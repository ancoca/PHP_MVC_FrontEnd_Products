...
//$(document).ready(function () {
    $('.prod').click(function () {
        ...
        $.get("module/products_frontend/controller/controller_products_frontend.php?idProduct=" + id, function (data, status) {
            ...
            $("#img_prod").html('<img src="' + product.image + '" height="75" width="75"> ');
            $("#name_prod").html(product.name);
            $("#description_prod").html("<strong>Description: <br/></strong>" + product.explicacion);
            $("#titration_prod").html("<strong>Titration:</strong>" + product.stock);
            $("#price_prod").html("Price: " + product.cost + " €");
